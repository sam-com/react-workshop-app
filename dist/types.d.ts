...
type LazyComponents = Record<string, React.LazyExoticComponent<NoPropsComponent> | undefined>;
...
export type { FileInfo, LazyComponents, Imports, Backend, NoPropsComponent, DynamicImportFn, DefaultDynamicImportFn, };
